...
@budget_bp.get("/<event>/<dept>/budget/primary/new")
...
@budget_bp.post("/<event>/<dept>/budget/primary")
...
@budget_bp.get("/<event>/<dept>/budget/item/<public_id>")
...
@budget_bp.get("/<event>/<dept>/budget/item/<public_id>/edit")
def work_item_edit(event: str, dept: str, public_id: str):
    ...
    for acc in fixed_cost_accounts:
        ...
        fixed_cost_data.append({
            ...
            "existing_quantity": (
                existing_line.budget_detail.quantity
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/edit")
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/fixed-costs")
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/submit")
def work_item_submit(event: str, dept: str, public_id: str):
    ...
    # Validate: all lines must have budget details
    for line in work_item.lines:
...
@budget_bp.get("/<event>/<dept>/budget/supplementary/new")
...
@budget_bp.post("/<event>/<dept>/budget/supplementary")
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/checkout")
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/checkin")
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/request-info")
...
@budget_bp.post("/<event>/<dept>/budget/item/<public_id>/respond-info")
